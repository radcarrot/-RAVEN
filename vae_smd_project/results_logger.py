...
class RunLogger:
    ...
    def __init__(
        ...
        self.metrics         = {}        # f1, pa_f1, pa_precision, pa_recall, roc_auc
    ...
    def log_train_scores(
        ...
        Args:
            train_scores    : 1D array of per-window MSE scores on training data.
            threshold       : Active threshold used for inference.
            threshold_pot   : POT threshold (reference).
            threshold_pct99 : 99th percentile threshold (reference).
        """
    ...
    def log_test_results(
        ...
        Args:
            test_scores_raw : 1D array — raw MSE scores before smoothing.
            test_scores     : 1D array — smoothed MSE scores.
            predictions     : 1D binary array — thresholded predictions.
            aligned_labels  : 1D binary array — ground truth aligned to windows.
            raw_f1          : Raw point-wise F1 score.
            pa_f1_result    : Either the dict from point_adjusted_f1() or a float.
            roc_auc         : ROC-AUC score (or None if not computed).
        """
